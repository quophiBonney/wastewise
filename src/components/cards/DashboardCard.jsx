  ...
  return (
    <div className="grid grid-cols-1 md:grid-2 lg:grid-cols-2 gap-5">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-5">
        <div className="border border-gray-200 rounded-lg bg-white p-4 space-y-7">
        ...
        <div className="shadow-lg rounded-lg bg-white p-4 col-span-2">
          <DashboarLineChart />
        </div>
      </div>
      <div className="shadow-lg rounded-lg pb-0 mb-0  flex flex-col items-center justify-center">
        ...
        <div className="mt-3 rounded-b-2xl h-32 flex justify-between items-center px-5 flex-col md:flex-row gap-3 w-full">
          <div>
